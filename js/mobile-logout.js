/**
 * Sticky bottom Log out button on mobile when a logout link exists.
 */
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '  .nav-actions a[href*="logout"], .nav-actions .btn-logout {',
      '    display: inline-flex !important; align-items: center; justify-content: center;',
      '    min-height: 40px; padding: 8px 14px !important; font-size: 0.82rem !important;',
      '    font-weight: 700; border-radius: 999px; border: 2px solid #DC2626 !important;',
      '    color: #DC2626 !important; background: #FEF2F2 !important; white-space: nowrap;',
      '  }',
      '  .mobile-logout-bar {',
      ...
      '    -webkit-backdrop-filter: blur(12px); border-top: 1px solid #E5E7EB;',
      '    box-shadow: 0 -6px 20px rgba(15,23,42,0.08);',
      '  }',
      '  .mobile-logout-btn {',
      '    display: inline-flex; align-items: center; justify-content: center; gap: 8px;',
      '    width: 100%; max-width: 420px; min-height: 48px; border-radius: 999px;',
      '    background: #DC2626; color: #fff !important; font-weight: 700; font-size: 1rem;',
      '    text-decoration: none !important; box-shadow: 0 6px 16px rgba(220,38,38,0.28);',
      '  }',
  ...
  function ensureBar() {
    ...
    bar.innerHTML = '<a href="' + href + '" class="mobile-logout-btn" aria-label="Log out">🚪 Log out</a>';
