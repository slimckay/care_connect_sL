        ...
        if (empty($errors)) {
            try {
                if ($isEdit) {
                    ...
                    $_SESSION['provider_success'] = $success;
            ...
            <form action="provider-registration.php" method="POST" enctype="multipart/form-data" class="form-card" style="padding: 36px 40px;">
                ...
                <div class="form-section">
                    ...
                    <p style="color: var(--muted); font-size: 0.9rem; margin-bottom: 16px;">
                        These documents help us verify your identity and credentials.
                    </p>
                    ...
                    <div class="form-row">
                        <div>
                            ...
                            <div class="file-upload-box" onclick="document.getElementById('id_photo').click()">
                                ...
                                <input type="file" id="id_photo" name="id_photo" accept="image/*" <?php echo (!empty($profile['id_photo'])) ? '' : 'required'; ?>>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="file-upload-box" onclick="document.getElementById('license_photo').click()">
                                ...
                                <input type="file" id="license_photo" name="license_photo" accept="image/*" <?php echo (!empty($profile['license_photo'])) ? '' : 'required'; ?>>
                            </div>
